...
def basic_information(current_directory, operator, user ,orderID, order_volume, well_new_or_old, wellID, well_position, step, order_date, rundate, file_name):
...
def save_data_control(current_directory, operator, user, orderID, order_volume, well_new_or_old, wellID, well_position, step, order_date, rundate, file_name):
    ...
    if reply == "yes":
        ...
        save_data.save_protocol(current_directory, empty_line, operator, user, order_volume, orderID, step, order_date, rundate, file_name)
    else: #will not save data
        exit()

def save_well_data(column_whole, column_des):
    print(column_whole, column_des)