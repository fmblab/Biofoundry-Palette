...
def start(current_directory, operator, user, orderID, order_volume, well_new_or_old, wellID, well_position, step, order_date, deadline, file_name):
    #change format
    ...
    adder.basic_information(current_directory, operator, user , orderID, order_volume, well_new_or_old, wellID, well_position, step, order_date, deadline, file_name)
    ...
    adder.save_data_control(current_directory, operator, user, orderID, order_volume, well_new_or_old, wellID, well_position, step, order_date, deadline, file_name)